...
Public Class fmrDetalleIngreso1
    ...
    Private Sub frmingreso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DbSGSv3DataSet.ingreso' table. You can move, or remove it, as needed.
        '    Me.IngresoTableAdapter.Fill(Me.DbSGSv3DataSet.ingreso)
        mostrar()
    ...
    Private Sub txtidproveedor_KeyDown(sender As Object, e As KeyEventArgs) Handles txtidproveedor.KeyDown
        If e.KeyData = Keys.Enter Then : Dim fingreso As New fIngreso
            Dim dt_productos As New DataTable
            fingreso.buscarCodigoBarra(txtidproveedor.Text, dt_productos)
            If dt_productos.Rows.Count > 0 Then
                Me.txtnombre_proveedor.Text = dt_productos.Rows(0).Item("Descripcion")
            End If
        End If
